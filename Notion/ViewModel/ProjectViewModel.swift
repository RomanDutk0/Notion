...
class ProjectViewModel: ObservableObject {
    ...
    Project(
      ...
      taskCards: [
        ...
        Task(fieldValues: [
          ...
          FieldValue(
            field: Field(
              name: "Status", type: .selection, options: ["Not Started", "In Progress", "Done"]),
            value: .selection(["Not Started"])
          ),
          FieldValue(
            field: Field(name: "GO", type: .selection, options: ["In Progress1", "Done1"]),
      ...
      template: [
        ...
        FieldValue(
          field: Field(
            name: "GO", type: .selection, options: ["Not Started1", "In Progress1", "Done1"]),
          value: .selection(["Not Started1"])),
  ...
  func getAllFields(_ project: Project) -> [Field] {
    ...
    guard
      ...
      !project.taskCards[0].fieldValues.isEmpty
    else {
  ...
  func saveProject(
    projects: inout [Project], fields: [Field], projectIcon: String, projectName: String
  ) {
    ...
    let newProject = Project(
      icon: projectIcon, projectName: projectName, taskCards: [newTask],
