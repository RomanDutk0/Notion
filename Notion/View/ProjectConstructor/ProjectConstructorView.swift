      ...
      VStack {
        ...
        Button {
          projectModel.saveProject(
            projects: &projectModel.projects, fields: fields, projectIcon: projectIcon,
    ...
    NavigationView {
      ...
      .toolbar {
        ToolbarItem(placement: .confirmationAction) {
          Button("Add") {
            projectModel.addField(
              name: newFieldName, type: newFieldType, optionsString: newFieldOptions,
              fields: &fields)
